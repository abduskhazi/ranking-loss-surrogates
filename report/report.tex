...
\subsection{Comparing results with SOAT models}
...
In Figure~\ref{fig:FinalAblation} we show how each of the surrogates built in the previous sections compare against each other.
