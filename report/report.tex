...
\hspace*{\algorithmicindent} \textbf{Input} : $s_{\theta}$ \Comment{Surrogate to train}
\begin{algorithmic}[1]
...
Hence, restarting the training (from the saved model in our case) should improve our finetuned surrogate model.
