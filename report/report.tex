...
In this chapter we chronologically build a surrogate model based on Ranking losses.
...
Firstly,  we decided to model a scoring function using a deep neural network.
