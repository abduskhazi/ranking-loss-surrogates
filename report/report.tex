...
If the random variable $\textbf{X}$ is a vector in $\mathbb{R}^d$,  then each value in the vector can be considered as a random variable.
...
The probability density function \cite{MITMLBook}
