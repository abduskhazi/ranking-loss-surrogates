...
Hence,  our thesis uses the list wise approach to ranking.
...
In this chapter,  we first assume that a good surrogate model of suffient representational capacity already exists.
...
In this section we analyse the loss functions.
Then, we discuss the implementation details of the function used in our model.
