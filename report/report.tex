...
To keep the output score in a defined range, we utilized the range controlling mechanism discussed in Appendex~\ref{chap:chap:OutputRangeControl}.

We sample the testing data from the following ranges to evaluate our learned model:
\begin{itemize}
\item The Same range as seen during training i.e $[1, 100]$.
\item A completely different range as seen during training i.e $[-100, -1]$.
\item A hybrid range i.e $[-50, 50]$.
\end{itemize} 
