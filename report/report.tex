...
\end{figure}
Where \textbf{X} represents the set of configurations for a evaluated for a model in a particular data set.
...
Of this \textbf{HPO-B-v2} contains distlilled the search spaces that have the most data and 
\begin{itemize}
\item Organisation of HPO-B (Diagram using tzk...)
\item Seed used for randomness
\item Comparing only HPO-B-v3 for consitency in compare as recommended in the paper.
\end{itemize}
...
The second baseline from the non transfer learning domain was FSBO.
We choose this because this gave the state of the art results.
...
% ~\cite{DBLP:journals/corr/abs-2106-06257}.
