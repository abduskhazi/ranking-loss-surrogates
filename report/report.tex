...
On the other hand, the surrogate can be further meta-trained (aka finetuned) using the available metadata of the target task.
...
HPO using Sequential Model Based Optimization (SMBO)~\cite{NIPS2011_86e8f7ab} is a convenient method proposed in the literature.
