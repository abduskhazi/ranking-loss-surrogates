...
For some search spaces,  during the course of training our ranking loss model,  the validation errors did not reduce at all.
Figure~\ref{fig:NegativeLearning} shows an illustration of this using the training loss curves of search space id 5527.
