...
* Extract the `hpob-data.zip` to the location `./HPO_B/hpob-data/`.
* After successful extraction, all the required files (in the json format) will be present in the `./HPO_B/hpob-data/` folder.
