...
def average_ranks_OLD(X_query, rl_model):
...
# Actually UCB ranks.
def average_ranks_Depricated(input, incumbent, rl_model):
...
class RankingLossSurrogate(nn.Module):
    ...
    def observe_and_suggest(self, X_obs, y_obs, X_pen):
        ...
        # Depricated --> # scores = average_ranks((X_obs, y_obs, X_pen), self.incumbent, self)
